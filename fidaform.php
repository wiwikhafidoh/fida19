...
<body bgcolor="green">
<form action="fidatampil.php" method="post">
...
<p>
Hobi :
<input type="checkboox" name="hobi1" value="Olahraga">Olahraga
<input type="checkboox" name="hobi2" value="Musik">Musik
<input type="checkboox" name="hobi3" value="Jalan-Jalan">Jalan-Jalan
<p>
